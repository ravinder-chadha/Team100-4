...
import 'package:flutter_shop_app/modules/cart/cart_screen.dart';
import 'package:flutter_shop_app/styles/color.dart';
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        scaffold.showSnackBar(
                          SnackBar(
                            content: const Text('Thanks for your feedback! You got a reward!'),
                            action: SnackBarAction(label: 'USE', onPressed: (){
